      ...
      <div className='flex flex-row items-end justify-center h-screen p-15'>
        ...
        <div className='bg-white flex flex-col items-center justify-center p-8 gap-6 w-[42%] h-full rounded-2xl shadow-lg  shadow-gray-400'>
          ...
          <div className='flex flex-col items-center justify-center w-full'>
            ...
            <p className='text-md font-medium text-gray-500 text-center'>Login To Explore Asthestics of Delicacies WorldWide</p>
          </div>
          ...
          <div className='flex items-center justify-center w-1/3 rounded-2xl bg-gray-300'>
            <div className='w-full text-center p-1 cursor-pointer' onClick={ToSignUp}>SignUp</div>
            <div className='w-full text-center p-1 bg-black text-white rounded-xl cursor-pointer'>Login</div>
          </div>
          ...
          <form onSubmit={handleSubmit} className='flex flex-col gap-6 p-2 w-[70%]'>
            ...
            <button type="submit" className="bg-black text-white px-4 py-2 rounded-lg mb-10">Login</button>
